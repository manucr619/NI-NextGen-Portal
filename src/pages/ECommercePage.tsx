      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage your online payment solutions.
          </p>
        </div>
        ...
        <div className="grid gap-6">
          ...
          >
            <h2 className="text-xl font-semibold mb-4">E-commerce Integration</h2>
            <p>Your online payment integration settings will appear here.</p>
          </div>
        </div>
      </div>
    </DashboardLayout>
